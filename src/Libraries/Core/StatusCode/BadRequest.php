...
/**
 * Throw this whenever you want to redirect the current controller to a "bad request" controller
 */
class BadRequest extends \Exception implements StatusCode {
	...
	public static function getClassName(): \Core\ClassName {
		return new \Core\ClassName("StatusCode\BadRequest");
	}
}
